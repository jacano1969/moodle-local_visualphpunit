...
require_once($CFG->dirroot.'/local/visualphpunit/run_tests_mform.php');

require_login(1);
require_capability('report/unittest:view', get_system_context());

$PAGE->set_url('/local/visualphpunit/run_tests.php');
$PAGE->set_pagelayout('standard');
$title = 'Visual PHPUnit';
...
if ($data) {
    redirect(new moodle_url('/local/visualphpunit/run_tests.php', array('testdirectory' => $data->testdirectory)));
}
...
include ($CFG->dirroot.'/local/visualphpunit/index.php');
